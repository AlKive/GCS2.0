...
const MissionControlIcon = () => <svg className="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z"/></svg>;
  ...
  return (
    <aside className="w-80 bg-gcs-dark text-white flex-col p-6 hidden lg:flex">
      ...
      <nav className="flex flex-col space-y-3">
        ...
        <NavItem icon={<MissionControlIcon />} label="Mission Control" view="missionControl" active={currentView === 'missionControl'} onClick={() => onNavigate('missionControl')} />
